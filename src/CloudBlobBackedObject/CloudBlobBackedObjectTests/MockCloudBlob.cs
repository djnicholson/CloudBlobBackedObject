...
{
    class MockCloudBlob : ICloudBlob
    {
        ...
        public TimeSpan BreakLease(TimeSpan? breakPeriod = default(TimeSpan?), AccessCondition accessCondition = null, BlobRequestOptions options = null, OperationContext operationContext = null)
        {
            throw new NotImplementedException();
        }
